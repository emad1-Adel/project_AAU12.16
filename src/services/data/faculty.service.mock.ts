...
const mockFacultyMembers: FacultyMemberDetail[] = [
  {
    ...
    experience: [
      { id: '1', positionAr: 'أستاذ دكتور', positionEn: 'Professor', organizationAr: 'جامعة الجيل الجديد', organizationEn: 'New Generation University', periodAr: '2018 - الآن', periodEn: '2018 - Present' },
  ...
  },
  {
    ...
    experience: [
      { id: '1', positionAr: 'أستاذ مشارك', positionEn: 'Associate Professor', organizationAr: 'جامعة الجيل الجديد', organizationEn: 'New Generation University', periodAr: '2020 - الآن', periodEn: '2020 - Present' },
    ],
  },
  {
    id: '3',
