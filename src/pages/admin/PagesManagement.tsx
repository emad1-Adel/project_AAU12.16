...
const pages = [
  {
    ...
    titleEn: 'New Generation University',
    contentAr: 'جامعة الجيل الجديد هي مؤسسة تعليمية رائدة تهدف إلى تقديم تعليم عالي الجودة يواكب متطلبات العصر الحديث.',
    contentEn: 'New Generation University is a leading educational institution that aims to provide high-quality education that meets the requirements of the modern era.',
  ...
  },
  {
    ...
    contentEn: 'New Generation University provides an integrated educational environment including student activities and various services.',
    visionAr: '',
    visionEn: '',
    missionAr: '',
    missionEn: '',
  },
  {
    ...
    contentEn: 'Learn about the admission requirements at New Generation University and registration steps.',
    visionAr: '',
    visionEn: '',
    missionAr: '',
    missionEn: '',
